...
<div class="time-countdown">
	...
	<div class="headinggg">The contest ends in: </div>
	<div class="inlinee" id='hours'>00 <br>hours</div>
	<div class="inlinee" id='min'>00 <br>min</div>
	<div class="inlinee" id='sec'>00 <br>sec</div>
...
if(!isset($noAnswer))
{
 	echo "<form style='position: relative;padding-bottom: 20px;margin-top: 30px' action='$submitForm' method='POST' class='answerForm'>"; 
 	...
 	if($num!=1)
 	{
 		echo "<input type='submit' name='submi' value='&#128161;' class='subButt' onclick='return getHint()'>";
 	}
 	echo "</form>";
}
...
<script type="text/javascript">
	...
	function internettime()
	{
		if(currTime<finalTime)
		{
			...
			hours.innerHTML=("0" + hoursLeft).slice(-2) + '<br>Hours&nbsp;';
			minutes.innerHTML=("0" + minutesLeft).slice(-2) + '<br>Minutes';
			seconds.innerHTML=("0" + parseInt(secondsLeft)).slice(-2) + '<br>Seconds';
