...
<div class="side-door" id='login-window'>
	...
	<img src="images/logo-separate/logo_enigma.png" style="width: 80%;margin-bottom: 40px">
		<div class="head-of-countdown">
			The contest begins in: 
		</div>
		<div class="head-of-countdown" id='days' style="margin-bottom: 20px">
			7 days
		</div>

		<div id='hour'>00<br><span>Hours</span></div><div class="colan">&nbsp;:<br>&nbsp;</div>
		<div id='minutes'>00<br><span>Minutes</span></div><div class="colan">&nbsp;:<br>&nbsp;</div>
		<div id='seconds'>00<br><span>Seconds</span></div><div class="colan">&nbsp;<br>&nbsp;</div>
